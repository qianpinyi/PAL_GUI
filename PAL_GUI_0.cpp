...
//	4.Others
	...
	Memo:
		How about widgets manage using BalanceTree?
		Update screen use discretization(or divide to many blocks,and update the blocks that change happens in it)?
		Var:Current pos widget
		PUI_cfg
		//Render to Texture, it is mainly used for smooth scroll
